...
// Signup Route (Encrypting password before saving)
app.post('/signup', async (req, res) => {
  ...
  // Signin Route (Checking encrypted password)
...
//         req.params.id,
//         { itemName, description, currentBid, closingTime },
//         { new: true }
//       );
    ...
    try {
      ...
      const updatedAuction = await AuctionItem.findByIdAndUpdate(
        id,
        {
          itemName,
          description,
          currentBid: startingBid, // Update bid only if it makes sense
          closingTime,
        },
